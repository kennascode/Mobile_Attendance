...
<style>
body  {
    background-image: url("picture/att.jpg");
...
<body>
    ...
    <div id="wrapper">
       ...
       <!-- Sidebar -->
			...
			<ul class="sidebar-nav">
				...
				<li>
					<a href="takeview.php" title="Take Attendance"><span class="glyphicon glyphicon-check"></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;take Attendance</a>
				</li>
				<li>
 ...
 <?php while($row = mysqli_fetch_array($search_result)):?>
  ...
  <td></td>
  <td>Present<input type ="checkbox"></td>
  <td>Late<input type ="checkbox"></td>
  <td>Absent<input type ="checkbox"></td>
  <td>Excuse<input type ="checkbox"></td>
  </tr>
