...
<body>
    ...
    <div id="wrapper">
       ...
       <!-- Sidebar -->
			...
			<ul class="sidebar-nav">
				...
				<li>
					<a href="studentclass.php" title="Student Class"><span class="glyphicon glyphicon-book"></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Student Class</a>
				</li>
				<li>
  ...
  <tbody>
    <tr>
	 ...
	 <td>
	<div class="btn-group">
	<button type="button" class="btn btn-secondary dropdown-toggle" data-toggle="dropdown" aria=haspopup="true" aria-expanded="false">Option</button>
		<div class="dropdown-menu">
			<a class="dropdown-item" href="class.php?edit=<?php echo $row["Class_ID"]; ?>">Edit</a></br>
