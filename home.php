...
<style>
body	{
	background-image: url("picture/pep.jpg");
...
<br><br><br>	
  ...
  <img src="picture/pep.jpg" width="500" height="300" class="card-img-top">
  <div class="card-body">
    <h3 class="card-title"><strong><font color="white">Mobile Attendance</font></strong></h3>
  </div>
  <ul class="list-group list-group-flush">
    <li class="list-group-item"><a href="studview.php">View Student</a></li>
    <li class="list-group-item"><a href="subview.php">View Subject</a></li>
    <li class="list-group-item"><a href="classview.php">View Class</a></li>
	<li class="list-group-item"><a href="studclassview.php">View StudentClass</a></li>
  </ul>
