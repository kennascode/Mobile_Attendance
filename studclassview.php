...
<head>
	<title>Student Class View</title>
    <meta charset="utf-8">
 ...
 <?php while($row = mysqli_fetch_array($search_result)):?>
  <tbody>
    <tr>
	 ...
	 <td>
		<div class="dropdown">
  <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenu2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Options</button>
			<div class="dropdown-menu" aria-labelledby="dropdownMenu2">
					<a class="dropdown-item" href="studentclass.php?delete=<?php echo $row["number"]; ?>" onclick="return confirm('Are you sure?');">Delete</a></br>
					<a class="dropdown-item" href="studentclass.php?edit=<?php echo $row["Class_ID"]; ?>" onclick="return confirm('Are you sure?');">Edit</a>
			</div>
		</div>
