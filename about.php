    ...
    <div id="wrapper">
       ...
       <!-- Sidebar -->
			...
			<ul class="sidebar-nav">
				...
				<li>
					<a href="studentclass.php" title="Subject"><span class="glyphicon glyphicon-folder-open"></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Student Class</a>
				</li>
				<li>
					<a href="genreport.php" title="Read"><span class="glyphicon glyphicon-list-alt"></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;General Report</a>
				</li>
				<li>
